...
Click [here](https://github.com/FaurnsGoldberg/Persistent-SS13/archive/master.zip) to get the latest code as a .zip file, then unzip it to wherever you want.
...
When that opens, type in:
    ...
    git clone https://github.com/FaurnsGoldberg/Persistent-SS13.git
