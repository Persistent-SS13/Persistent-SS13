...
/proc/stripped_input(var/mob/user, var/message = "", var/title = "", var/default = "", var/max_length=MAX_MESSAGE_LEN, var/min_length=2)
	var/name = input(user, message, title, default)
	return strip_html_properly(name, max_length)

//Filters out undesirable characters from names
/proc/reject_bad_name(var/t_in, var/allow_numbers=0, var/max_length=MAX_NAME_LEN, var/min_length=2)
	...
	if(number_of_alphanumeric < min_length)	return		//protects against tiny names like "A" and also names like "' ' ' ' ' ' ' '"
