...
/datum/hud
	...
	var/list/underwear_inventory = list() // PERSISTANT EDIT! this is a further hidden nest of hud objects
...
/datum/hud/proc/show_hud(version = 0)
	...
	switch(display_hud_version)
		if(HUD_STYLE_STANDARD)	//Default HUD
			...
			if(underwear_inventory.len && underwear_shown)
				mymob.client.screen += underwear_inventory
...
/datum/hud/proc/hidden_inventory_update()
	return
/datum/hud/proc/underwear_inventory_update()
	return
