...
/obj/screen/robot/id_button
	name = "PDA Slot"
	icon_state = "inv4"

/obj/screen/robot/id_button/Click()
	if(issilicon(usr))
		var/mob/living/silicon/robot/R = usr
		R.toggle_module(4)
...
//Module select
	...
	using = new /obj/screen/robot/id_button()
	using.screen_loc = "CENTER+3:18,SOUTH:5"
	static_inventory += using
	mymobR.inv4 = using
	
	mymobR.module_state_4.mouse_opacity = initial(mymobR.module_state_4.mouse_opacity)
	mymobR.module_state_4.layer = 20
	mymobR.module_state_4.plane = HUD_PLANE
	mymobR.module_state_4.screen_loc = mymobR.inv4.screen_loc
	static_inventory += mymobR.module_state_4
...
//Intent
	...
	static_inventory += using
	action_intent = using
// persistant edit! battery + WILL hud!
	mymobR.focuss = new /obj/screen/focuss()
	infodisplay += mymobR.focuss
	mymobR.cells = new /obj/screen/cells()
	infodisplay += mymobR.cells
...
//Installed Module
	...
	mymobR.thruster_button = new /obj/screen/robot/thrusters()
	mymobR.thruster_button.screen_loc = ui_borg_thrusters
...
/datum/hud/proc/update_robot_modules_display()
	...
	if(!R.module)		// warp back here
		return
		
	if(R.ionpulse)
		R.client.screen += R.thruster_button
	else	
		R.client.screen -= R.thruster_button
