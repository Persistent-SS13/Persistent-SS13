...
/obj/screen/mechcntrlpanel
	name = "toggle control panel"
	icon_state = "blank"
	screen_loc = "EAST-1:0,CENTER-1:15"

/obj/screen/mechcntrlpanel/Click()
...
/obj/screen/staminas
	name = "stamina"
	icon_state = "stamina1"
	screen_loc = "EAST-1:28,SOUTH+5:15"
...
/obj/screen/mechcells
	name = "mech cell"
	icon_state = "blank"
	screen_loc = "EAST-1:0,SOUTH+5:15"
/obj/screen/focuss
	name = "will"
	icon_state = "focus1"
	screen_loc = "EAST-1:28,SOUTH+5:15"
/obj/screen/viewstats
	name = "view stats"
	icon_state = "viewstats"
	screen_loc = "15:-3,6:-15"
/obj/screen/viewstats/Click()
	// At this point in client Click() code we have passed the 1/10 sec check and little else
	// We don't even know if it's a middle click
	if(ismob(usr))
		var/mob/M = usr
