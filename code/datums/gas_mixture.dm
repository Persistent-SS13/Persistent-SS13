...
/datum/gas_mixture
	...
	var/nitrogen = 0
	var/toxins = 0
	map_storage_saved_vars = "oxygen;carbon_dioxide;nitrogen;toxins;temperature;trace_gases;volume;"
	...
	if(toxins > MINIMUM_HEAT_CAPACITY)
		...
		if(temperature_scale > 0)
			...
			if(oxygen > toxins*PLASMA_OXYGEN_FULLBURN)
				...
				plasma_burn_rate = (temperature_scale*(25/PLASMA_OXYGEN_FULLBURN))/PLASMA_BURN_RATE_DELTA
