...
/mob/living/silicon/robot/proc/diag_hud_set_borgcell()
	...
	if(cells)
		if(stat == DEAD || !cell)
			cells.icon_state = "cell12"
		else
			switch(cell.charge/cell.maxcharge)
				if(0.95 to INFINITY) cells.icon_state = "cell1"
				if(0.85 to 0.95) cells.icon_state = "cell2"
				if(0.75 to 0.85) cells.icon_state = "cell3"
				if(0.65 to 0.75) cells.icon_state = "cell4"
				if(0.55 to 0.65) cells.icon_state = "cell5"
				if(0.45 to 0.55) cells.icon_state = "cell6"
				if(0.35 to 0.45) cells.icon_state = "cell7"
				if(0.25 to 0.35) cells.icon_state = "cell8"
				if(0.15 to 0.25) cells.icon_state = "cell9"
				if(0.05 to 0.15) cells.icon_state = "cell10"
				if(0 to 0.05) cells.icon_state = "cell11"
	if(focuss)
		if(stat == DEAD)
			focuss.icon_state = "focus12"
		else
			switch(100-focusloss)
				if(95 to INFINITY) focuss.icon_state = "focus1"
				if(85 to 95) focuss.icon_state = "focus2"
				if(75 to 85) focuss.icon_state = "focus3"
				if(65 to 75) focuss.icon_state = "focus4"
				if(55 to 65) focuss.icon_state = "focus5"
				if(45 to 55) focuss.icon_state = "focus6"
				if(35 to 45) focuss.icon_state = "focus7"
				if(25 to 35) focuss.icon_state = "focus8"
				if(15 to 25) focuss.icon_state = "focus9"
				if(5 to 15) focuss.icon_state = "focus10"
				if(-INFINITY to 5) focuss.icon_state = "focus11"
