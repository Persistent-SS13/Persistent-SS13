...
/obj/item/weapon/circuitboard/id_dispenser
	name = "circuit board (ID Dispenser)"
	build_path = /obj/machinery/id_dispenser
	board_type = "machine"
	origin_tech = ""
	frame_desc = "Requires 5 pieces of cable, 1 Scanning Module, 1 Manipulator, 1 Power Cell and 1 Capacitor."
	req_components = list(
