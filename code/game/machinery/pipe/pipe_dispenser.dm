...
/obj/machinery/pipedispenser/resource
	name = "Resource Pipe Dispenser"
	icon = 'icons/obj/stationobjs.dmi'
	icon_state = "pipe_d"
	density = 1
	anchored = 1.0

/obj/machinery/pipedispenser/resource/MouseDrop_T(var/obj/structure/resourceconstruct/pipe as obj, mob/usr as mob)
	if(!usr.canmove || usr.stat || usr.restrained())
		return
...
/obj/machinery/pipedispenser/resource/attack_hand(user as mob)
	if(..())
		return

	var/dat = {"<b>Resource Pipes</b><br><br>
<A href='?src=\ref[src];dmake=0'>Pipe</A><BR>
<A href='?src=\ref[src];dmake=1'>Bent Pipe</A><BR>
<A href='?src=\ref[src];dmake=2'>Trunk</A><BR>
<A href='?src=\ref[src];dmake=3'>Resource Inlet</A><BR>
<A href='?src=\ref[src];dmake=4'>Resource Outlet</A><BR>
"}
...
// 0=straight, 1=bent, 2=trunk, 3 = inlet 4 = outlet


/obj/machinery/pipedispenser/resource/Topic(href, href_list)
	if(..())
		return
	usr.set_machine(src)
	src.add_fingerprint(usr)
