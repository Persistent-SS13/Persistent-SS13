/obj/mecha/working/ripley
	desc = "Autonomous Power Loader Unit with several external hard points to carry mining and cargo equipment. Perfect for moving heavy objects."
	name = "APLU \"Ripley\""
	icon_state = "ripley"
	initial_icon = "ripley"
	step_in = 5
	...
	lights_power = 7
	deflect_chance = 15
	damage_absorption = list("brute"=0.6,"fire"=0.95,"bullet"=0.8,"laser"=0.9,"energy"=0.9,"bomb"=0.6)
	max_equip = 6
