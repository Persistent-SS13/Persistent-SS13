...
/obj/effect/landmark/mine
	name = "mineloc"
	icon = 'icons/mob/screen_gen.dmi'
	icon_state = "x"
	anchored = 1.0
	
/obj/effect/landmark/mine/New()
	qdel(src)
/obj/effect/landmark/mine/tantilineloc/New()
	tantilinelocs += loc
	..()
/obj/effect/landmark/mine/congloloc/New()
	conglolocs += loc
	..()
/obj/effect/landmark/mine/plasmaloc/New()
	plasmalocs += loc
	..()
/obj/effect/landmark/mine/orichilumloc/New()
	orichilumlocs += loc
	..()
