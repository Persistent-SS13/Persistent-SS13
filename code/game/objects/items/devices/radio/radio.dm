...
/mob/living/silicon/robot/has_internal_radio_channel_access(var/mob/user, var/list/req_one_accesses)
	return has_access(list(), req_one_accesses, user.get_access())
