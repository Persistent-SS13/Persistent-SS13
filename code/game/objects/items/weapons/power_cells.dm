/obj/item/weapon/stock_parts/cell
	...
	var/brute = 0	// THESE ARE USED TO HOLD DAMAGE
	var/burn = 0	// TAKEN WHILE THE CELL IS INSIDE A ROBOT
	var/rigged = 0		// true if rigged to explode
	var/minor_fault = 0 //If not 100% reliable, it will build up faults.
	var/chargerate = 1000 //how much power is given every tick in a recharger
	var/self_recharge = 0 //does it self recharge, over time, or not?
	var/component_name = "power cell"
	var/datum_type = /datum/robot_component/cell
	map_storage_saved_vars = "density;icon_state;dir;name;pixel_x;pixel_y;charge;brute;burn;rigged;minor_fault"
