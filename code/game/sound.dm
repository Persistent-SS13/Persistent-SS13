...
/mob/proc/playsound_local(var/turf/turf_source, soundin, vol as num, vary, frequency, falloff, is_global, sound/S)
	...
	if(isturf(turf_source))
		...
		var/datum/gas_mixture/hearer_env = T.return_air()								// wew is this ever fancy
		var/datum/gas_mixture/source_env = turf_source.return_air()													// makes me wonder why 
																					// there are explosion sounds in my star trek the next generation tv show
