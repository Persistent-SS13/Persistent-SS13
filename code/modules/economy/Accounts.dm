...
/proc/create_savedaccount(var/new_owner_name, var/starting_funds, var/list/account)
	...
	var/datum/money_account/M = new()
	M.owner_name = new_owner_name
	M.remote_access_pin = text2num(account["pin"])
	M.money = starting_funds
	M.account_number = text2num(account["num"])
...
/datum/transaction
	...
	var/time = ""
	var/source_terminal = ""
	map_storage_saved_vars = "target_name;purpose;amount;date;time;source_terminal"
/*
