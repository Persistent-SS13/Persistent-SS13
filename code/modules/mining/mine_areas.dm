						...
						switch(pick(1,2,3))
							if(1)
								...
								spawn(10)
									...
									to_chat(M, "-[used] WILL")
								M.playsound_local(M.loc, pick('sound/effects/earthquake_short.ogg','sound/effects/earthquake_short2.ogg'), 50, 0)
								shake_camera(M, 10, 2)
							if(2)
						...
						switch(pick(1,2,3))
							if(1)
								...
								spawn(10)
									...
									to_chat(M, "-[used] WILL")
								M.playsound_local(M.loc, pick('sound/effects/earthquake_short.ogg','sound/effects/earthquake_short2.ogg'), 70, 0)
