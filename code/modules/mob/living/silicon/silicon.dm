...
/mob/living/silicon/get_access()
	// return IGNORE_ACCESS //silicons always have access -- that doesnt sound very persistant
	if(!src.mind) // uncontrolled robots always have access
		return IGNORE_ACCESS
	else if(src.mind.assigned_job)
		return src.mind.assigned_job.get_access()
	else
		return list()
