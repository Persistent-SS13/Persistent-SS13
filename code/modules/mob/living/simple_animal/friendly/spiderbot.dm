/mob/living/simple_animal/spiderbot
	...
	name = "Spider-bot"
	desc = "Slightly less humiliating than being carried from place to place."
...
/mob/living/simple_animal/spiderbot/proc/transfer_personality(var/obj/item/device/mmi/M as obj)
		...
		src.dna = M.brainmob.dna.Clone()
		src.name = "[M.brainmob.name]"

/mob/living/simple_animal/spiderbot/UnarmedAttack(atom/A)
...
/mob/living/simple_animal/spiderbot/start_pulling(var/atom/movable/AM)//Prevents spiderbot from pulling things
	...
	if(mmi)
		...
		if(mind)	
			if(!mmi.brainmob)
				mmi.brainmob = new()
				if(dna)
					mmi.brainmob.dna = dna.Clone()
				mmi.brainmob.name = name
