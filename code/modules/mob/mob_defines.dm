/mob
	...
	var/obj/screen/focuss = null
	var/obj/screen/view_stats = null
	var/obj/screen/mechcells = null
	var/obj/screen/mechcntrlpanel = null
	...
	*/
	...
	var/atom/movable/pulling_helper = null
	var/next_move = null
	...
	var/lying = 0
	var/recovering = 0 // PERSISTANT used when the matrix needs to be reset
	var/deleting = 0 // PERSISTANT used to force delete a brain
	var/doing_action = 0 // PERSISTANT only one action available at a time
	var/last_autoemote = 0 // PERSISTANT autoemote transcribes certain actions into visible messages.. they will only trigger if world.time > last_autoemote
	var/lying_prev = 0
	var/canmove = 1
	var/lastpuke = 0
	var/unacidable = 0
	...
	var/age = 0 // moved to mob for persistance
