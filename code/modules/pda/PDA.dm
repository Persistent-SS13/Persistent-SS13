...
/obj/item/device/pda/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
	...
	data["ownjob"] = ownjob					// ...and what does he do?			hey thats a great movie im assuming this guy went into standup after finishing the pda
...
/obj/item/device/pda/AltClick(mob/user)
	..()
	if(issilicon(usr) && !istype(src, /obj/item/device/pda/borg))
		return
