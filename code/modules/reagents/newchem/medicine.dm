...
/datum/chemical_reaction/synaptizine
	...
	id = "synaptizine"
	result = "synaptizine"
	required_reagents = list("oxygen" = 1, "chlorine" = 1, radium = 1, plasma = 1)
	result_amount = 3
	mix_message = "The mixture bubbles slowly, making a foul smelling odor/"
	
/datum/reagent/synaptizine
	name = "Synaptizine"
	id = "synaptizine"
	description = "Synaptizine is an advanced medication that can stimulate the basic functions of the brain stem such as breathing and the beating of the heart."
	color = "#D1D1F1"
