...
/obj/docking_port/mobile/proc/dock(obj/docking_port/stationary/S1, var/firstmove = 0)
	. = canDock(S1)
	if(.)
	...
	for(var/turf/T in L)
		for(var/atom/movable/AM in T)
			if(ismob(AM))
				...
				//	var/mob/living/M = AM
				//	M.Paralyse(10)					// getting slammed by a shuttle *aint* persistant
